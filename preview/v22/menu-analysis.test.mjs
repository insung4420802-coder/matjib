...
test('invalid tuple length, field types and values fail closed',()=>{
  const invalid=[tuple.slice(0,4),[...tuple,'extra','g','overflow'],[null,'そば',850,'m',null],['소바',5,850,'m',null],['','',850,'m',null],['소바','そば','850','m',null],['소바','そば',-1,'m',null],['소바','そば',Infinity,'m',null],['소바','そば',850,'main',null],['소바','そば',850,'__proto__',null],['소바','そば',850,'m','false'],null,'text'];
